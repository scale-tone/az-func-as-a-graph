...
var FSharpFunctionProjectParser = /** @class */ (function (_super) {
                ...
                switch (_a.label) {
                    case 0:
                        promises = functionNames.map(function (name) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, this._fileSystemWrapper.findFileRecursivelyAsync(hostJsonFolder, '.+\\.fs$', true, this.getFunctionStartRegex(name))];
                                    case 1:
                                        match = _a.sent();
                                        if (!match) {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        _b = __asyncValues(this._fileSystemWrapper.findFunctionsRecursivelyAsync(projectFolder, new RegExp('.+\\.fs$', 'i'), this.getFunctionAttributeRegex()));
                        _d.label = 2;
    ...
    FSharpFunctionProjectParser.prototype.getFunctionAttributeRegex = function () {
        return {
