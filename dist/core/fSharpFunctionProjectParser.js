...
class FSharpFunctionProjectParser extends functionProjectCodeParser_1.FunctionProjectCodeParser {
    getFunctionsAndTheirCodesAsync(functionNames, hostJsonFolder) {
        return __awaiter(this, void 0, void 0, function* () {
            const promises = functionNames.map((name) => __awaiter(this, void 0, void 0, function* () {
                const match = yield this._fileSystemWrapper.findFileRecursivelyAsync(hostJsonFolder, '.+\\.fs$', true, this.getFunctionStartRegex(name));
                if (!match) {
                    return undefined;
                }
    ...
    traverseProjectCode(projectFolder) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const result = {};
            try {
                for (var _b = __asyncValues(this._fileSystemWrapper.findFunctionsRecursivelyAsync(projectFolder, new RegExp('.+\\.fs$', 'i'), this.getFunctionAttributeRegex())), _c; _c = yield _b.next(), !_c.done;) {
                    const func = _c.value;
...
//# sourceMappingURL=fSharpFunctionProjectParser.js.map