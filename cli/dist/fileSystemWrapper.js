...
var fileSystemWrapperBase_1 = require("az-func-as-a-graph.core/dist/fileSystemWrapperBase");
    ...
    FileSystemWrapper.prototype.readFile = function (path) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fileSystem.promises.readFile(path, { encoding: 'utf8' })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    FileSystemWrapper.prototype.isDirectory = function (path) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fileSystem.promises.lstat(path)];
                    case 1: return [2 /*return*/, (_a.sent()).isDirectory()];
                }
            });
        });
    };
    FileSystemWrapper.prototype.readDir = function (path) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fileSystem.promises.readdir(path)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
