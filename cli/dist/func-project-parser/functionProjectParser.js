...
var FunctionProjectParser = /** @class */ (function () {
    function FunctionProjectParser(_fileSystemWrapper, _log) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 6:
                        ...
                        _a.label = 7;
                    case 7: return [4 /*yield*/, parser.traverseFunctions(projectFolder)];
                    case 8:
                        functions = _a.sent();
                ...
                switch (_a.label) {
                    case 0:
                        promises = functionNames.map(function (name) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, this._fileSystemWrapper.findFileRecursivelyAsync(this._fileSystemWrapper.joinPath(hostJsonFolder, name), '(index\\.ts|index\\.js|__init__\\.py)$', true)];
                                    case 1:
                                        match = _a.sent();
                                        if (!match) {
